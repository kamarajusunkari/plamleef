  ...
  return (
    <div className="animate-fadeIn">
      <div className="flex items-center gap-4 mb-6">
        <Link href="/student/dashboard" className="w-8 h-8 rounded-xl bg-[#F0F4FA] flex items-center justify-center hover:bg-[#E8EDF5] transition-colors">
          ...
          {filtered.map((ann) => (
            <div key={ann.id} className="bg-white rounded-2xl p-5 border border-[#E8EDF5]">
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#FFF7F4] flex items-center justify-center shrink-0">
